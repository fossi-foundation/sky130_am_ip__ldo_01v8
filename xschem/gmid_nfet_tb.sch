...
foreach l_act 0.5 0.75 1 2 5 10 20
  ...
  hardcopy charac_nfet_idn.ps $plot_idn ylog ylimit 1e-9 1e-3 xlabel 'Vgs' ylabel 'Id / W*' title 'NFET normalized characteristic ($plot_sweep)'
  hardcopy charac_nfet_gmid.ps $plot_gmid xlog xlimit 1e-9 1e-3 xlabel 'Id / W*' ylabel 'gm / Id' title 'NFET normalized characteristic ($plot_sweep)'
  hardcopy charac_nfet_gds.ps $plot_gds loglog xlimit 1e-9 1e-3 xlabel 'Id / W*' ylabel 'gds' title 'NFET normalized characteristic ($plot_sweep)'
  hardcopy charac_nfet_ro.ps $plot_ro loglog xlimit 1e-9 1e-3 xlabel 'Id / W*' ylabel 'Ro' title 'NFET normalized characteristic ($plot_sweep)'
  hardcopy charac_nfet_avo.ps $plot_avo loglog xlimit 1e-9 1e-3 xlabel 'Id / W*' ylabel 'Avo' title 'NFET normalized characteristic ($plot_sweep)'
  hardcopy charac_nfet_ft.ps $plot_ft loglog xlimit 1e-9 1e-3 xlabel 'Id / W*' ylabel 'ft' title 'NFET normalized characteristic ($plot_sweep)'
  hardcopy charac_nfet_vdsat.ps $plot_vdsat xlog xlimit 1e-9 1e-3 xlabel 'Id / W*' ylabel 'Vdsat' title 'NFET normalized characteristic ($plot_sweep)'
  quit
.endc
"}
